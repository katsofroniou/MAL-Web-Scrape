...
def anime():
    ...
    # Convert dictionaries to comma-separated string of names
...
def manga():
    ...
    # Convert lists of dictionaries to comma-separated string
